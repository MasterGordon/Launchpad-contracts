 ...
 */
abstract contract ERC2612 is Initializable, ERC20Upgradeable, IERC2612 {
    ...
    function __ERC2612_init(string memory name_, string memory symbol_) internal initializer {
